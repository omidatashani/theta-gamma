...
function [analytic_sig] = theta_hilbert(sig)
...
freqsbands=[6 12]; %% Frequency band can be defined based on your focuse in Hertz here

% transition width
trans_width = 0.2; % fraction of 1, thus 20%

% filter order
filt_order = 1100;%750round(3*(fs/filtbound(1)));700
